OC.L10N.register(
    ...
    {
    "Saving..." : "Gemmer...",
    "Saved watermark" : "Gemte vandmærke",
    "None" : "Ingen",
    "All" : "Alle",
    ...
    "Download this revision" : "Download denne revision",
    ...
    "Please enter filename to which this document should be stored." : "Angiv filnavn som dette dokument skal gemmes under. ",
    "Save As" : "Gem som",
    ...
    "Secure View (with watermarks)" : "Sikker visning (med vandmærker)",
    "can print / export" : "kan udskrive / eksportere",
    "Open in Collabora with Secure View" : "Åbn i Collabora med sikker visning",
    "Open in Collabora" : "Åbn i Collabora",
    "Document" : "Dokument",
    "Spreadsheet" : "Regneark",
    "Presentation" : "Præsentation",
    "Could not create file" : "Kunne ikke oprette fil",
    "View/Edit in Collabora" : "Vis/redigér i Collabora",
    "Office" : "Kontor",
    ...
    "Collabora Online: SSL/TLS handshake failed with the host \"%s\"." : "Collabora Online: SSL/TLS-forhandling mislykkedes med værten \"%s\".",
    ...
    "Collabora Online: Cannot open document." : "Collabora Online: Kan ikke åbne dokumentet.",
    ...
    "Insufficient file permissions." : "Utilstrækkelige filrettigheder.",
    "Saved" : "Gemt",
