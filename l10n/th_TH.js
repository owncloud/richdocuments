OC.L10N.register(
    ...
    "Saved watermark" : "ลายน้ำที่บันทึกไว้",
    "None" : "ไม่มี",
    "All" : "ทั้งหมด",
    ...
    "No documents were found. Upload or create a document to get started!" : "ยังไม่มีเอกสารเลย คุณสามารถเริ่มต้นอัปโหลดหรือสร้างเอกสารได้เลย!",
    ...
    "More versions..." : "เวอร์ชันอื่น ๆ ...",
    "Just now" : "เมื่อสักครู่",
    "Failed to revert the document to older version" : "ไม่สามารถย้อนกลับเอกสารไปเป็นเวอร์ชันก่อนหน้า",
    ...
    "File \"{name}\" already exists, do you want to overwrite it ?" : "มีไฟล์ \"{name}\" อยู่แล้ว คุณต้องการเขียนทับหรือไม่?",
    "File \"{name} already exists" : "มีไฟล์ \"{name}\" อยู่แล้ว",
    "Secure View (with watermarks)" : "ดูแบบปลอดภัย (พร้อมลายน้ำ)",
    "can print / export" : "สามารถ พิมพ์/ส่งออก",
    "Open in Collabora with Secure View" : "เปิดด้วย Collabora กับ Secure View",
    "Open in Collabora" : "เปิดด้วย Collabora",
    "Document" : "เอกสาร",
    ...
    "Collabora Online: SSL/TLS handshake failed with the host \"%s\"." : "การทำงานร่วมกัน: SSL/TLS ไม่สามารถใช้งานกับโฮสต์ \"%s\"",
    ...
    "Enabled encryption type will result in limited functionality of the app. App requires privileged access to the files, and the only currently supported type is master key encryption." : "ประเภทการเข้ารหัสที่เปิดใช้งานจะส่งผลให้แอปพลิเคชันมีข้อจำกัด แอปต้องใช้สิทธิ์พิเศษในการเข้าถึงไฟล์และประเภทที่สนับสนุนในปัจจุบันเท่านั้นคือการเข้ารหัส Master key",
    ...
    "URL (and port) of the Collabora Online test server." : "ลิงก์และพอร์ต ของเซิร์ฟเวอร์ทดสอบ Collabora ออนไลน์",
    ...
    "Enable access for external apps" : "เปิดใช้งานการเข้าถึงแอปฯภายนอก",
    "Add" : "เพิ่ม",
    ...
    "Settings" : "ตั้งค่า",
    "Open documents in Secure View with watermark by default" : "เปิดเอกสารในมุมมองที่ปลอดภัยพร้อมลายน้ำตามค่าเริ่มต้น",
    ...
    "Strictly confidential. Only for " : "เป็นความลับสุดยอดสำหรับ",
    ...
    "This link has been expired or is never existed. Please contact the person who shared it with you for details." : "ลิงก์นี้ได้หมดอายุแล้วหรือไม่เคยมีอยู่ กรุณาติดต่อบุคคลที่แชร์กับคุณสำหรับรายละเอียด"
},
"nplurals=1; plural=0;");
