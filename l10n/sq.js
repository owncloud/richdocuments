OC.L10N.register(
    ...
    "Saved" : "U ruajt",
    "Invalid WOPI Url. Only http or https scheme is allowed." : "URL WOPI e pavlefshme. Lejohet vetëm skemë http ose https.",
    ...
    "Set watermark text for Secure View. To include the user email address dynamically, use the {viewer-email} variable." : "Caktoni tekst “watermark”-u për Parje të Siguruar. Që të përfshihet në mënyrë dinamike adresa email e përdoruesit, përdorni ndryshoren {viewer-email}.",
    ...
    "Collabora Online 22.05.10 and above required" : "Lyp Collabora Online 22.05.10 e sipër",
    ...
    "Update the existing key or save empty to delete" : "Përditësoni kyçin ekzistues ose ruajeni të zbrazët, që të fshihet",
    "Add new key" : "Shtoni kyç të ri",
