OC.L10N.register(
    ...
    "Please ask your administrator to check the Collabora Online server setting. The exact error message was: " : "コラボラ オンラインの管理者にサーバー設定を確認するようお願いしてください。抽出したログは次の通り：",
    ...
    "Please ask your administrator to check the Collabora Online server setting." : "コラボラ オンラインの管理者にサーバー設定を確認するようお願いしてください。",
    ...
    "Saved" : "保存されました",
    "Saved with error: Collabora Online should use the same protocol as the server installation." : "保存時にエラー：コラボラ オンラインは、サーバーインストールと同じプロトコルを使用する必要があります。",
    "Saving..." : "保存中...",
    "None" : "なし",
    "All" : "すべて",
    ...
    "Groups" : "グループ",
    "Test server" : "テストサーバー",
    "URL (and port) of the Collabora Online test server." : "コラボラ オンライン テストサーバーのURL (とポート)。",
