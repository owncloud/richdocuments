OC.L10N.register(
    ...
    "can download" : "pode descargarse",
    "protect with watermarks" : "protexer con marcas de auga",
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "O cifrado coa chave do usuario está activado (só se admite o cifrado de chave mestra). O aplicativo require acceso privilexiado aos ficheiros e o cifrado de usuario activado producirá unha funcionalidade limitada da aplicación.",
