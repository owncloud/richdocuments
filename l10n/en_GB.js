OC.L10N.register(
    ...
    "Just now" : "Just now",
    "Cannot load document revisions" : "Cannot load document revisions",
    ...
    "None" : "None",
    "All" : "All",
    "Strictly confidential. Only for {viewer-email}" : "Strictly confidential. Only for {viewer-email}",
    ...
    "Collabora Online: Unable to read WOPI discovery for given document" : "Collabora Online: Unable to read WOPI discovery for given document",
    "Can't create document" : "Can't create document",
    "Saved" : "Saved",
    "Invalid WOPI Url. Only http or https scheme is allowed." : "Invalid WOPI URL. Only http or https scheme is allowed.",
    ...
    "Secure View for Collabora Online" : "Secure View for Collabora Online",
    ...
    "Enforce to open documents always in Secure View mode with watermark" : "Enforce to open documents always in Secure View mode with watermark",
    "Set \"can print/export\" as default share permission" : "Set \"can print/export\" as default share permission",
    "Set \"Secure View (with watermarks)\" as default share permission" : "Set \"Secure View (with watermarks)\" as default share permission",
    "Set watermark text for Secure View. To include the user email address dynamically, use the {viewer-email} variable." : "Set watermark text for Secure View. To include the user email address dynamically, use the {viewer-email} variable.",
    "Zotero for Collabora Online" : "Zotero for Collabora Online",
    "Connect Zotero for Bibliography and Citation inside Collabora Online." : "Connect Zotero for Bibliography and Citation inside Collabora Online.",
    "Collabora Online 22.05.10 and above required" : "Collabora Online 22.05.10 and above required",
    "Enable Zotero for all users" : "Enable Zotero for all users",
    "Zotero integration is disabled, ask your administrator to enable it." : "Zotero integration is disabled, ask your administrator to enable it.",
    "Zotero Personal API Key:" : "Zotero Personal API Key:",
    "Update the existing key or save empty to delete" : "Update the existing key or save empty to delete",
    "Add new key" : "Add new key",
    "To generate the API key navigate in Zotero to" : "To generate the API key navigate in Zotero to",
    "Home > Settings > Feeds/API > Create new private key" : "Home > Settings > Feeds/API > Create new private key"
},
