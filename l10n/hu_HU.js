OC.L10N.register(
    ...
    "Please ask your administrator to add ca-chain.cert.pem to the ca-bundle.crt, for example \"cat /etc/loolwsd/ca-chain.cert.pem >> <server-installation>/resources/config/ca-bundle.crt\" . The exact error message was: " : "Kérje meg az adminisztrátort, hogy adja hozzá a ca-chain.cert.pem a ca-bundle.crt -hez, példaképp: \"cat /etc/loolwsd/ca-chain.cert.pem >> <server-installation>/resources/config/ca-bundle.crt\" . A pontosan a hiba üzenet: ",
    ...
    "New Document.docx" : "Új .docx dokumentum",
    "New Spreadsheet.xlsx" : "Új .xlsx táblázat",
    "New Presentation.pptx" : "Új .pptx prezentáció",
    ...
    "Saved" : "Elmentve!",
    "Saved with error: Collabora Online should use the same protocol as the server installation." : "Hibával elmentve: A Collabora Online-nak ugyanazt a protokollt kell használnia mint a kiszolgáló telepítésnek.",
    "Saving..." : "Mentés...",
    "None" : "Egyik sem",
    "All" : "Mind",
    ...
    "Download this revision" : "Ez a változat letöltése",
    "Restore this revision" : "Ez a változat visszaállítása",
    "Latest revision" : "Legújabb verzió",
    "More versions..." : "További változatok...",
    "Just now" : "Épp most",
    "Failed to revert the document to older version" : "Nem sikerült a dokumentumot visszaállítani régebbi változatra",
    ...
    "Share" : "Megosztás",
    "Share with people on other servers using their Federated Cloud ID username@example.com/owncloud" : "Megosztás emberekkel, másik kiszolgálókon, az Ő egyesített felhő azonosítójukkal username@example.com/owncloud",
    ...
    "Apply" : "Alkalmaz",
    "Enable test server for specific groups" : "Teszt kiszolgáló engedélyezése a meghatározott csoportokra",
    "Groups" : "Csoportok",
    "Test server" : "Teszt kiszolgáló",
    "URL (and port) of the Collabora Online test server." : "A Collabora Online Teszt kiszolgáló URL-je (és portja).",
    "Enable edit for specific groups" : "Szerkesztés engedélyezése meghatározott csoportokra",
