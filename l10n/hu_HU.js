OC.L10N.register(
    ...
    "Please ask your administrator to add ca-chain.cert.pem to the ca-bundle.crt, for example \"cat /etc/loolwsd/ca-chain.cert.pem >> <server-installation>/resources/config/ca-bundle.crt\" . The exact error message was: " : "Kérje meg a rendszergazdát, hogy adja hozzá a ca-chain.cert.pem a ca-bundle.crt -hez, példaképp: \"cat /etc/loolwsd/ca-chain.cert.pem >> <server-installation>/resources/config/ca-bundle.crt\" . A pontos hibaüzenet: ",
