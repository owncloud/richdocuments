OC.L10N.register(
    ...
    "Collabora Online: Cannot resolve the host \"%s\"." : "Collabora on-line: não é possível resolver o anfitrião \"%s\".",
    "Collabora Online: Cannot connect to the host \"%s\"." : "Collabora on-line: não é possível ligar ao anfitrião \"%s\".",
    ...
    "Error while changing permissions" : "Erro ao alterar as permissões",
    ...
    "Share" : "Partilhar",
    "Share with people on other servers using their Federated Cloud ID username@example.com/owncloud" : "Partilhe com as pessoas noutros servidores utilizando o Federated Cloud ID deles username@example.com/owncloud",
    ...
    "Upload" : "Enviar",
    "Wrong password. Please retry." : "Palavra-passe errada. Por favor, tente de novo.",
    "OK" : "OK",
    "Guest %s" : "Convidado %s",
