OC.L10N.register(
    ...
    "Collabora Online: SSL/TLS handshake failed with the host \"%s\"." : "Не удалось установить соединение SSL/TLS с хостом \"%s\".",
    ...
    "Settings" : "Настройки",
    "Open documents in Secure View with watermark by default" : "Открыть документы в безопасном просмотре с водяным знаком по умолчанию",
