OC.L10N.register(
    ...
    "can download" : "можно скачивать",
    "protect with watermarks" : "защитить водяными знаками",
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "Включено шифрование ключом пользователя (поддерживается только при шифровании через мастер-ключ). Приложению требуется привилегированный доступ к файлам, так что включение пользовательского шифрования приведёт ограничению возможностей приложения.",
