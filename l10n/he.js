OC.L10N.register(
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "הצפנה עם מפתח משתמש מופעלת (תומך רק בהצפנה על בסיס מפתח מסטר). היישום דורש הרשאת גישה מיוחסת לקבצים, והפעלת הצפנת משתמש גוררת פונקציונליות מוגבלת של היישום.",
