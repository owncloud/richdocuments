OC.L10N.register(
    ...
    "Collabora Online: SSL/TLS handshake failed with the host \"%s\"." : "Collabora מקוון: חתימת SSL/TLS נכשלה אצל מארח \"%s\".",
    ...
    "Collabora Online: Cannot open document." : "Collabora מקוון: לא ניתן לפתוח את המסמך.",
    ...
    "Enabled encryption type will result in limited functionality of the app. App requires privileged access to the files, and the only currently supported type is master key encryption." : "סוג הצפנה מופעל יביא לפונקציונליות מוגבלת של האפליקציה. האפליקציה דורשת הרשאות גישה לקבצים והסוג היחיד הנתמך כרגע הנו הצפנת מפתח ראשי.",
    ...
    "Add" : "הוספה",
    "Use Canonical webroot" : "השתמש ב- Canonical webroot",
    ...
    "Strictly confidential. Only for " : "בסודיות מוחלטת. רק עבור",
