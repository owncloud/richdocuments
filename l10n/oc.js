OC.L10N.register(
    ...
    "Collabora Online: Malformed URL \"%s\"." : "Collabora en linha : adreça malformada \"%s\".",
    "Collabora Online: Cannot resolve the host \"%s\"." : "Collabora en linha : Impossible de resòlvre lo nom d'òste \"%s\".",
    "Collabora Online: Cannot connect to the host \"%s\"." : "Collabora en linha : Impossible de se connectar a l'òste \"%s\".",
    "Collabora Online: SSL certificate is not installed." : "Collabora en linha : Lo certificat SSL es pas installat.",
    "Collabora Online unknown error: " : "Collabora en linha, error desconeguda : ",
    "Collabora Online: Invalid URL \"%s\"." : "Collabora en linha : Adreça invalida \"%s\".",
    "New Document.odt" : "Document Novèl.odt",
    "New Spreadsheet.ods" : "Novèl Fuèlh de Calcul.ods",
    "New Presentation.odp" : "Novèla Presentacion.odp",
    "New Document.docx" : "Novèl Document.docx",
    "New Presentation.pptx" : "Novèla Presentacion.pptx",
