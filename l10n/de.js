OC.L10N.register(
    ...
    "protect with watermarks" : "mit Wasserzeichen schützen",
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "Die Verschlüsselung mit dem Benutzerschlüssel ist aktiviert (nur die Hauptschlüsselverschlüsselung wird unterstützt). Die App erfordert einen privilegierten Zugriff auf die Dateien, und die aktivierte Benutzerverschlüsselung führt zu einer eingeschränkten Funktionalität der App.",
