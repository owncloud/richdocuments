OC.L10N.register(
    ...
    "Please enter filename to which this document should be stored." : "Por favor, introduce el nombre de archivo con el que se debería almacenar este documento.",
    ...
    "protect with watermarks" : "proteger con marcas de agua",
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "El cifrado con clave de usuario está activado (solo se admite el cifrado de la clave maestra). La aplicación requiere acceso privilegiado a los archivos, y el cifrado activado del usuario dará como resultado una funcionalidad limitada de la aplicación.",
