OC.L10N.register(
    ...
    "Enabled encryption type will result in limited functionality of the app. App requires privileged access to the files, and the only currently supported type is master key encryption." : "El tipo de cifrado habilitado resultará en una funcionalidad limitada de la aplicación. La aplicación requiere privilegios de acceso a los ficheros, y el único tipo soportado actualmente es el cifrado con clave maestra.",
