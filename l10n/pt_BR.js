OC.L10N.register(
    ...
    "protect with watermarks" : "proteger com marcas d'água",
    ...
    "Encryption with user key is enabled (only supported is master key encryption). App requires priviledged access to the files, and user encryption enabled will result in limited functionality of the app." : "A criptografia com a chave do usuário está ativada (somente suportada é a criptografia da chave mestra). O aplicativo requer acesso privilegiado aos arquivos e a criptografia do usuário ativada resultará em uma funcionalidade limitada do aplicativo.",
