            ...
            var __vue_render__ = function () {
              ...
              return _c("main", [
                _c(
                  ...
                  [
                    _c("oc-modal", {
                      staticClass: "oc-mb-l uk-position-absolute",
                      attrs: {
                        title: _vm.$gettext("Save As"),
                        "button-cancel-text": _vm.$gettext("Cancel"),
                        "button-confirm-text": _vm.$gettext("Save"),
                        "has-input": true,
                        "input-label": _vm.$gettext("New filename"),
                        "input-description": _vm.$gettext(
                          "Please enter filename to which this document should be stored."
                        ),
                        "input-value": _vm.fileName,
                        hidden: _vm.hideSaveAs,
                      },
                      on: { cancel: _vm.cancelSaveAs, confirm: _vm.confirmSaveAs },
                    }),
                    _vm._v(" "),
                    _c("div", { attrs: { id: "mainContainer" } }),
                  ],
                  1
                ),
              ])
